...
const Signup = () => {
  ...
  const validateFields = () => {
    const nameError = validateSignupForm.validteName(name);
    const emailError = validateSignupForm.validteEmail(email);
    const passwordError = validateSignupForm.validtePass(password);
